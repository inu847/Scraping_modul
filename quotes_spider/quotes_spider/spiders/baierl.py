...
class BaierlSpider(scrapy.Spider):
    ...
    def parse_car(self, response):
        ...
        color = response.xpath('//li[@class="intcolor"]/span[@class="value"]/text()').extract_first()
        engine = response.xpath('//li[@class="engdescription"]/span[@class="value"]/text()').extract_first()
